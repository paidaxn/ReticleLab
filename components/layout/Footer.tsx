...
export function Footer() {
  return (
    <footer className="border-t-2 border-valorant-gray-200 bg-valorant-gray-50" role="contentinfo">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-valorant-gray-600" role="list">
